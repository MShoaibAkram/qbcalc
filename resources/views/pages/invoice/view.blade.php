        ...
        <form class="small-box p-3">
            ...
            <div class="row form-group align-items-end">
                ...
                <div class="col-md-1 col-sm-12">
                    <button class="btn btn-primary" type="button" onclick="loadInvoice()">Go</button>
                </div>
...
@section('scripts')
    ...
    var loadInvoice = function(){
        $.ajax({
            ...
            type: 'POST',
            data: {_token: CSRF_TOKEN, queryStr:$("#invoiceSearch").val()},
            dataType: 'JSON',
            success: function (data) {
                if(data.status == 200){
                    //Data Found...
                    var invoice = data.invoice;
                    $('#invoiceNumber').val(invoice.ref_number);
                    $('#customerName').val(invoice.customer_name);
                    $('#dueDate').val(invoice.due_date);


                }else{
                    alert('No Receipt Found against this number');
                }
            }
        });
    }
