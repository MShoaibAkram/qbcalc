<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="{{ route('report.commRptSalesRep') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('Comm Rpt by Rep') }}
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('report.unpaidInvoice') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
        ...
        <li class="nav-item">
            <a href="{{ route('bill.view') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('View Bills') }}
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('bill.sendToQB') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('Send Bills to QB') }}
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('history.update') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('Update History') }}
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('report.current') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('Current Reports') }}
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('report.history') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('History Reports') }}
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('report.other') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('Other Reports') }}
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('commission.plan') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('Commission Plans') }}
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('system.option') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('Setup Options') }}
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('system.utility') }}" class="nav-link">
                <i class="nav-icon fas fa-thumbtack"></i>
                <p>
                    {{ __('System Utilities') }}
                </p>
